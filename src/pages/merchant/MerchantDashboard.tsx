    ...
    <div className="min-h-screen bg-background relative">
      ...
      <header className="sticky top-0 z-50 glass-subtle border-b border-border/50">
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold text-gradient">KisanSetu</span>
            <Badge variant="secondary" className="ml-2 glass-subtle">Merchant</Badge>
          </div>
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <Card className="group cursor-pointer glass-card btn-ripple" onClick={() => navigate("/merchant/orders")}>
            <CardHeader>
              <div className="w-16 h-16 rounded-2xl bg-primary/10 flex items-center justify-center mb-4 transition-all duration-300 group-hover:bg-primary/20 group-hover:shadow-glow group-hover:scale-105">
                <ClipboardList className="w-8 h-8 text-primary transition-colors duration-300 group-hover:text-primary-foreground" />
              </div>
              <CardTitle className="text-xl flex items-center gap-2">
                View Requests
                {orderStats.pending > 0 && <Badge variant="destructive" className="animate-pulse-gentle">{orderStats.pending} new</Badge>}
              </CardTitle>
              <CardDescription className="text-muted-foreground">Manage incoming orders from farmers</CardDescription>
            </CardHeader>
            <CardContent>
              <Button variant="outline" className="w-full transition-all duration-300 group-hover:bg-primary group-hover:text-primary-foreground group-hover:border-primary group-hover:shadow-glow">View All Requests</Button>
            </CardContent>
          </Card>

          <Card className="group cursor-pointer glass-card btn-ripple" onClick={() => navigate("/merchant/stock")}>
            <CardHeader>
              <div className="w-16 h-16 rounded-2xl bg-primary/10 flex items-center justify-center mb-4 transition-all duration-300 group-hover:bg-primary/20 group-hover:shadow-glow group-hover:scale-105">
                <Package className="w-8 h-8 text-primary transition-colors duration-300 group-hover:text-primary-foreground" />
              </div>
              <CardTitle className="text-xl">Manage Stock</CardTitle>
              <CardDescription className="text-muted-foreground">View and update your product inventory</CardDescription>
            </CardHeader>
            <CardContent>
              <Button variant="outline" className="w-full transition-all duration-300 group-hover:bg-primary group-hover:text-primary-foreground group-hover:border-primary group-hover:shadow-glow">Manage Inventory</Button>
            </CardContent>
          </Card>
        </div>
        ...
        <Card className="glass-card">
          <CardHeader className="flex flex-row items-center justify-between">
            <div>
              ...
              <CardDescription className="text-muted-foreground">Your latest inventory items</CardDescription>
            </div>
            <Button onClick={() => navigate("/merchant/stock")} className="btn-primary-gradient" size="sm">
