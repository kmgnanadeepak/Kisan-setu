...
const DiseaseResult = () => {
  ...
  const downloadPrescription = (content) => {
    // A4-style formatting with proper margins
    const leftMargin = "        "; // A4 approx left margin (8 spaces)
    ...
    link.download = `Prescription_${today}.txt`;
  ...
  const handleDownloadPrescription = () => {
    ...
    // Create formatted content for A4 page
    const content = `
...
Contact: support@kisansetu.com | Emergency: 1800-XXX-XXXX
    ...
    // Download as formatted text file with A4 margins
